...
| [`BareMetal.Launcher`](docs/BareMetal.Launcher.md) | Hosted terminal/session launcher helpers. API wrapper, tiny store, session cards, idle display, reconnecting WebSocket attach, optional xterm bridge. | [15 KB](src/BareMetal.Launcher.js) | [8 KB](src/BareMetal.Launcher.min.js) | *React shell* + socket.io-client + state library |
...
| [`BareMetal.PicoScript`](docs/BareMetal.PicoScript.md) | Real PicoScript 16-opcode ISA: 4-frontend compiler (C/BASIC/Python/English) + deterministic VM + 456 host hooks across 63 namespaces (OS-worker, AI, storage, crypto, UI, capsules). Runs the same bytecode as PIOS bare metal. | [322 KB](src/BareMetal.PicoScript.js) | — | *No equivalent* — complete language VM + compiler in one file |
| [`BareMetal.WorkflowPico`](docs/BareMetal.WorkflowPico.md) | Compiles `BareMetal.Workflow` step lists to PicoScript (English dialect) — the visual workflow designer becomes a PicoScript frontend that runs on the browser/RP2350/PIOS/C# VM. Adds a "Compile to PicoScript" designer button. | [16 KB](src/BareMetal.WorkflowPico.js) | [8 KB](src/BareMetal.WorkflowPico.min.js) | *No equivalent* — visual workflow → deterministic bytecode |
| [`BareMetal.Report`](docs/BareMetal.Report.md) | Report & form builder. One templated layout engine, two modes: report (read-only table + aggregate footer) and form (read-write inputs + write-back). Visual designer to create/edit templates. Byte-aligned with PicoScript's picolayout. | [18 KB](src/BareMetal.Report.js) | [10 KB](src/BareMetal.Report.min.js) | *JasperReports (huge)*, hand-rolled table/form code |
...
| [`BareMetal.DocChain`](docs/BareMetal.DocChain.md) | Document chains/trees: defineType, create, derive (parent→child), transition (lifecycle), lineage, audit trail, graph output. | [18 KB](src/BareMetal.DocChain.js) | [8 KB](src/BareMetal.DocChain.min.js) | *Custom implementations* |
| [`BareMetal.Print`](docs/BareMetal.Print.md) | Schema-driven print: layout primitives (grid/table/barcode/QR), pagination, device abstraction (browser/PDF/thermal). | [22 KB](src/BareMetal.Print.js) | [10 KB](src/BareMetal.Print.min.js) | *pdfmake (≈300 KB)*, jsPDF (≈200 KB) |
| [`BareMetal.Scan`](docs/BareMetal.Scan.md) | Semantic ingestion: camera capture → decode (QR/barcode/OCR) → map to schema-typed object. | [19 KB](src/BareMetal.Scan.js) | [9 KB](src/BareMetal.Scan.min.js) | *html5-qrcode (≈100 KB)*, quagga (≈180 KB) |
| [`BareMetal.Authenticator`](docs/BareMetal.Authenticator.md) | TOTP/HOTP (RFC 6238/4226): setup, verify with drift, QR URI, replay guard, policy-based step-up auth. | [15 KB](src/BareMetal.Authenticator.js) | [7 KB](src/BareMetal.Authenticator.min.js) | *otplib (≈25 KB)*, speakeasy (≈30 KB) |
| [`BareMetal.Search`](docs/BareMetal.Search.md) | Full-text search: inverted index, TF-IDF ranking, facets, fuzzy matching, stemming, highlight. | [28 KB](src/BareMetal.Search.js) | [15 KB](src/BareMetal.Search.min.js) | *lunr (≈20 KB)*, flexsearch (≈30 KB), MiniSearch (≈25 KB) |
| [`BareMetal.Schedule`](docs/BareMetal.Schedule.md) | Cron parsing, job queue, intervals, retry with backoff, debounce/throttle, named jobs, lifecycle hooks. | [30 KB](src/BareMetal.Schedule.js) | [17 KB](src/BareMetal.Schedule.min.js) | *node-cron (≈10 KB)*, agenda (≈80 KB), bull (≈60 KB) |
| [`BareMetal.Inbox`](docs/BareMetal.Inbox.md) | Persistent notification center: channels, preferences, read/unread, grouping, priority, retention, search. | [18 KB](src/BareMetal.Inbox.js) | [10 KB](src/BareMetal.Inbox.min.js) | *Custom implementations* |
| [`BareMetal.Blob`](docs/BareMetal.Blob.md) | File/blob lifecycle: chunked upload, resumable, hash/checksum, encrypt, store adapters, lifecycle policies. | [36 KB](src/BareMetal.Blob.js) | [20 KB](src/BareMetal.Blob.min.js) | *tus-js-client (≈30 KB)*, uppy (≈200 KB) |
| [`BareMetal.Tenant`](docs/BareMetal.Tenant.md) | Multi-tenancy: isolation, context propagation, partitioning, hierarchy, limits, feature flags, suspend/activate. | [19 KB](src/BareMetal.Tenant.js) | [11 KB](src/BareMetal.Tenant.min.js) | *Custom implementations* |
