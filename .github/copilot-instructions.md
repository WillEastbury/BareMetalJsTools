...
| `BareMetal.Report.js` | `BareMetal.Report` | Report & form builder: one templated layout engine (report=read-only, form=read-write) + render, form write-back, and a visual designer to create/edit templates |
